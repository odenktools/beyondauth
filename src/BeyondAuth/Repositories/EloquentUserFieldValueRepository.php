...
use Pribumi\BeyondAuth\Contracts\UserFieldValueInterface as UserFieldValueRepository;

/**
 * Class EloquentUserFieldValueRepository.
 *
 ...
 */
class EloquentUserFieldValueRepository extends AbstractEloquentRepository implements UserFieldValueRepository
{
    /**
     * @param \Illuminate\Contracts\Foundation\Application $app
     * @param \Pribumi\BeyondAuth\Models\UserFieldValue $model
     */
    public function __construct(Application $app, UserFieldValue $model)
    {
