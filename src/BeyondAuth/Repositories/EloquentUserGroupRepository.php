...
/**
 * Class EloquentUserGroupRepository.
 *
 ...
 */
class EloquentUserGroupRepository extends AbstractEloquentRepository implements UserGroupRepository
{
    /**
     * @param \Illuminate\Contracts\Foundation\Application $app
     * @param \Pribumi\BeyondAuth\Models\UserGroup $model
     */
    public function __construct(Application $app, UserGroup $model)
    {
