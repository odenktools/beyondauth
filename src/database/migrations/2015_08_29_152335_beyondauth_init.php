...
{
    public $prefix = null;
    public $periode = ['key' => '', 'table' => ''];
    public $field_types = ['key' => '', 'table' => ''];
    public $users_menus = ['key' => '', 'table' => ''];
    public $users_permissions = ['key' => '', 'table' => ''];
    public $users = ['key' => '', 'table' => ''];
    public $company = ['key' => '', 'table' => ''];
    public $users_fields_groups = ['key' => '', 'table' => ''];
    public $users_fields = ['key' => '', 'table' => ''];
    public $users_groups = ['key' => '', 'table' => ''];
    public $users_groups_many = ['key' => '', 'table' => ''];
    public $users_fields_many = ['key' => '', 'table' => ''];
    public $users_fields_value = ['key' => '', 'table' => ''];
    public $users_permissions_many = ['key' => '', 'table' => ''];
    public $users_menus_many = ['key' => '', 'table' => ''];
    public $activation_users = ['key' => '', 'table' => ''];
    public $users_activation_many = ['key' => '', 'table' => ''];
    public $company_activation_many = ['key' => '', 'table' => ''];
    public $api_key_users = ['key' => '', 'table' => ''];
